...
import com.eduestudo.cursomc.domain.Pagamento;
import com.eduestudo.cursomc.domain.PagamentoComBoleto;
import com.eduestudo.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");
		...
		Estado est3 = new Estado(null,"Rondonia");
		
		Cidade c1 = new Cidade(null,"Uberlandia",est1);
		Cidade c2 = new Cidade(null,"São Paulo",est2);
		Cidade c3 = new Cidade(null,"Campinas",est2);
		Cidade c4 = new Cidade(null,"Ji-Parana",est3);
		...
		Cliente cli1 = new Cliente (null,"Maria Silva","maria@gmail.com","36378912377",TipoCliente.PESSOAFISICA, pe.encode("abcd1234"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		Cliente cli2 = new Cliente (null,"Eduardo Guimaraes","duhjipadm@gmail.com","36378912377",TipoCliente.PESSOAFISICA, pe.encode("abcd1234"));
		cli2.getTelefones().addAll(Arrays.asList("43433323","23238393"));
		cli2.addPerfil(Perfil.ADMIN);
		Endereco e1 = new Endereco (null,"Rua Flores","300","apto 303","Jardim","38220834",cli1,c1);
		Endereco e2 = new Endereco (null,"Avenida Matos","105","Sala 800","Centro","38777012",cli1,c2);
		Endereco e3 = new Endereco (null,"Dom Bosco","69",null,"Casa Preta","38777012",cli2,c4);
