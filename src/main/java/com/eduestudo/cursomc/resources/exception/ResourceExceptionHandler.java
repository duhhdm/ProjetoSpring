...
import com.eduestudo.cursomc.service.exceptions.DataIntegrityViolationException;
import com.eduestudo.cursomc.service.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> DataInegrityViolationException(DataIntegrityViolationException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> MethodArgumentNotValidException(MethodArgumentNotValidException e, HttpServletRequest request){
		ValidacaoErro err = new ValidacaoErro(System.currentTimeMillis(),HttpStatus.UNPROCESSABLE_ENTITY.value(), "Erro de validação", e.getMessage(), request.getRequestURI());
